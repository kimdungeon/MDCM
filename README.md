...
The supplemental data was aggregated and cleaned via a standalone Alteryx workflow. That file can be viewed [here](https://github.com/kimdungeon/MDCM/blob/master/MDCM%20Supplemental%20Data_3.19.24.xlsx).
